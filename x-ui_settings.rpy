...
init 1:
    ...
    python:
        ...
        def ks_sprite(char, expr_name, suffix_list=[]):
            ...
            regular_files = [(make_sprite_path(char, expr_name), expr_name), (make_sprite_path(char, expr_name, close=True), (expr_name) + ('_close'))]
    ...
    image heartattack alpha = im.Alpha('vfx/heart_attack.png', 0.29999999999999999)
    image heartattack residual = im.Alpha('vfx/heart_attack.png', 0.17000000000000001)
    ...
    python:
        emi_list = ['basic_happy', 'basic_happyblush', 'basic_confused', 'basic_concentrate', 'basic_shock', 'basic_annoyed', 'basic_hes', 'basic_grin', 'basic_closedhappy', 'basic_closedgrin', 'basic_closedsweat', 'excited_laugh', 'excited_amused', 'excited_joy', 'excited_happy', 'excited_happyblush', 'excited_hesitant', 'excited_proud', 'excited_circle', 'excited_sad', 'excited_smile', 'excited_happy', 'sad_angry', 'sad_annoyed', 'sad_pout', 'sad_shy', 'sad_shyblush', 'sad_depressed', 'sad_grit', 'sad_grin']
        make_sprites('emi', emi_list, ['gym'])
        emi_list_new = {'basic':(['happy', 'happyblush', 'confused', 'concentrate', 'shock', 'annoyed', 'hes', 'grin', 'closedhappy', 'closedgrin', 'closedsweat'], (94, 209), (110, 140)), 'excited':(['laugh', 'amused', 'joy', 'happy', 'happyblush', 'hesitant', 'proud', 'circle', 'sad', 'smile', 'happy'], (88, 222), (105, 168)), 'sad':(['angry', 'annoyed', 'pout', 'shy', 'shyblush', 'depressed', 'grit', 'grin'], (87, 212), (99, 150))}
        emicas_list = ['angry', 'awayfrown', 'blush', 'closedsmile', 'evil', 'frown', 'grin', 'grit', 'happy', 'neutral', 'pout', 'sad', 'smile', 'weaksmile', 'wink']
        ...
        def tremble_general(time, xpos, ypos, xanchor, yanchor, d, st, at):
            ...
            jitter = (0.00020000000000000001) * (random.randint(-(1), 1))
        ...
        def tf_centertremble_sit(d, st, at):
            return tremble_general(1.0, 0.5, 1.0900000000000001, 0.5, 1.0, d, st, at)
        centertremble_sit = Transform(function=tf_centertremble_sit)
        def tf_lefttremble(d, st, at):
            return tremble_general(1.0, 0.29999999999999999, 1.0, 0.5, 1.0, d, st, at)
        ...
        def tf_fourbounce30(d, st, at):
            return bounce_general(1.8, 0.040000000000000001, 4, d, st, at)
        def tf_onebounce(d, st, at):
            return bounce_general(0.5, 0.040000000000000001, 1, d, st, at)
        def tf_leftrock(d, st, at):
            import math
            n = scaled_runtime(4.0, st)
            m = (math.sin(((n) * (math.pi)) * (8))) * ((1) - (n))
            d.xpos = (0.29999999999999999) + ((m) * (0.050000000000000003))
            d.ypos = 1.0
            d.xanchor = 0.5
            d.yanchor = 0.90000000000000002
            return 0
        emigymbouncecomp = im.Composite((295, 630), (0, 0), 'sprites/emi/emi_basic_grin_gym.png', (0, 600), 'vfx/emi_gym_30pxlegs.png')
        emigymclosedbouncecomp = im.Composite((295, 630), (0, 0), 'sprites/emi/emi_basic_closedgrin_gym.png', (0, 600), 'vfx/emi_gym_30pxlegs.png')
        emigymconcentratebouncecomp = im.Composite((295, 630), (0, 0), 'sprites/emi/emi_basic_concentrate_gym.png', (0, 600), 'vfx/emi_gym_30pxlegs.png')
        emiannoyedbouncecomp = im.Composite((295, 660), (0, 0), 'sprites/emi/emi_basic_annoyed.png', (0, 600), 'vfx/emi_uni_60pxlegs.png')
        emihappybouncecomp = im.Composite((295, 630), (0, 0), 'sprites/emi/emi_basic_closedhappy.png', (0, 600), 'vfx/emi_uni_60pxlegs.png')
    ...
    python:
        rin_list = ['basic_absent', 'basic_amused', 'basic_awayabsent', 'basic_blush', 'basic_delight', 'basic_lucid', 'basic_sad', 'basic_surprised', 'basic_upset', 'basic_crying', 'basic_deadpanupset', 'basic_deadpan', 'basic_deadpanamused', 'basic_deadpancontemplation', 'basic_deadpandelight', 'basic_deadpannormal', 'basic_deadpansurprised', 'negative_angry', 'negative_annoyed', 'negative_confused', 'negative_crying', 'negative_sad', 'negative_spaciness', 'negative_worried', 'relaxed_boredom', 'relaxed_disgust', 'relaxed_doubt', 'relaxed_nonchalant', 'relaxed_sleepy', 'relaxed_surprised', 'back']
        make_sprites('rin', rin_list, ['cas'])
        make_sprites('rinpan', rin_list)
        rin_list_new = {'basic':(['absent', 'basic_amused', 'awayabsent', 'blush', 'delight', 'lucid', 'sad', 'surprised', 'upset', 'crying', 'deadpanupset', 'deadpan', 'deadpanamused', 'deadpancontemplation', 'deadpandelight', 'deadpannormal', 'deadpansurprised'], (34, 134), (100, 77)), 'negative':(['angry', 'annoyed', 'confused', 'crying', 'sad', 'spaciness', 'worried'], (30, 139), (86, 99)), 'relaxed':(['boredom', 'disgust', 'doubt', 'nonchalant', 'sleepy', 'surprised'], (72, 130), (158, 83)), '':(['back'], (0, 0), (0, 0))}
        lilly_list = ['basic_ara', 'basic_arablush', 'basic_cheerful', 'basic_cheerfulblush', 'basic_concerned', 'basic_displeased', 'basic_emb', 'basic_giggle', 'basic_listen', 'basic_oops', 'basic_planned', 'basic_pout', 'basic_reminisce', 'basic_sad', 'basic_satisfied', 'basic_sleepy', 'basic_smile', 'basic_smileclosed', 'basic_surprised', 'basic_veryemb', 'basic_weaksmile', 'behind_cheerful', 'behind_displeased', 'behind_emb', 'behind_cheerful', 'behind_giggle', 'behind_listen', 'behind_cheerful', 'behind_pout', 'behind_cheerful', 'behind_reminisce', 'behind_sleepy', 'behind_smile', 'behind_smileclosed', 'behind_weaksmile', 'cane_ara', 'cane_arablush', 'cane_cheerful', 'cane_cheerfulblush', 'cane_concerned', 'cane_displeased', 'cane_emb', 'cane_giggle', 'cane_listen', 'cane_mad', 'cane_oops', 'cane_planned', 'cane_pout', 'cane_reminisce', 'cane_sad', 'cane_satisfied', 'cane_sleepy', 'cane_smile', 'cane_smileclosed', 'cane_surprised', 'cane_weaksmile', 'back_devious', 'back_giggle', 'back_listen', 'back_pout', 'back_smile', 'back_smileclosed', 'back_surprise', 'back_sad']
        make_sprites('lilly', lilly_list, ['paj', 'cas', 'che', 'nak'])
        lilly_list_new = {'basic':(['ara', 'arablush', 'cheerful', 'cheerfulblush', 'concerned', 'displeased', 'emb', 'giggle', 'listen', 'oops', 'planned', 'pout', 'reminisce', 'sad', 'satisfied', 'sleepy', 'smile', 'smileclosed', 'surprised', 'veryemb', 'weaksmile'], (85, 98), ()), 'behind':(['cheerful', 'displeased', 'emb', 'cheerful', 'giggle', 'listen', 'cheerful', 'pout', 'cheerful', 'reminisce', 'sleepy', 'smile', 'smileclosed', 'weaksmile'], (85, 98), ()), 'cane':(['ara', 'arablush', 'cheerful', 'cheerfulblush', 'concerned', 'displeased', 'emb', 'giggle', 'listen', 'mad', 'oops', 'planned', 'pout', 'reminisce', 'sad', 'satisfied', 'sleepy', 'smile', 'smileclosed', 'surprised', 'weaksmile'], (85, 98), ()), 'back':(['devious', 'giggle', 'listen', 'pout', 'smile', 'smileclosed', 'surprise', 'sad'], (124, 94), ())}
        hana_list = ['basic_bashful', 'basic_distant', 'basic_normal', 'basic_smile', 'basic_worry', 'cover_bashful', 'cover_distant', 'cover_smile', 'cover_worry', 'def_shock', 'def_strain', 'def_worry', 'defarms_shock', 'defarms_strain', 'defarms_worry', 'emb_blushing', 'emb_blushtimid', 'emb_downsad', 'emb_downsmile', 'emb_downtimid', 'emb_emb', 'emb_sad', 'emb_smile', 'emb_timid']
        make_sprites('hanako', hana_list, ['cas'])
        hana_list_new = {'basic':(['bashful', 'distant', 'normal', 'smile', 'worry'], (113, 129), (186, 84)), 'cover':(['bashful', 'distant', 'smile', 'worry'], (113, 129), (186, 84)), 'def':(['def_shock', 'def_strain', 'def_worry'], (106, 130), (171, 77)), 'defarms':(['shock', 'strain', 'worry'], (106, 130), (171, 77)), 'emb':(['blushing', 'blushtimid', 'downsad', 'downsmile', 'downtimid', 'emb', 'sad', 'smile', 'timid'], (97, 141), (155, 93))}
        hanag_list = ['distant', 'drunkdistant', 'drunkgiggle', 'drunknormal', 'drunkpout', 'drunksad', 'drunksmile', 'drunkworry', 'stockdistant', 'stocknormal', 'stockworry', 'worry', 'normal', 'irritated', 'smile', 'worry']
        make_sprites('hanagown', hanag_list, ['blush'])
        hanag_list_new = ['distant', 'distant_blush', 'drunkdistant', 'drunkgiggle', 'drunknormal', 'drunkpout', 'drunksad', 'drunksmile', 'drunkworry', 'stockdistant_blush', 'stocknormal_blush', 'stockworry_blush', 'worry', 'normal', 'normal_blush', 'irritated', 'smile', 'worry', 'worry_blush']
    ...
    python:
        shizu_list = ['adjust_happy', 'adjust_angry', 'adjust_blush', 'adjust_smug', 'adjust_frown', 'adjust_noglasses', 'basic_normal', 'basic_normal2', 'basic_frown', 'basic_happy', 'basic_angry', 'basic_sparkle', 'behind_blank', 'behind_frown', 'behind_frustrated', 'behind_sad', 'behind_smile', 'behind_smilelow', 'cross_angry', 'cross_rage', 'cross_rageclosed', 'cross_shock', 'cross_stunned', 'cross_wut', 'out_serious']
        shizu_list_new = {'adjust':(['happy', 'angry', 'blush', 'smug', 'frown', 'noglasses'], (66, 161), (98, 108)), 'basic':(['normal', 'normal2', 'frown', 'happy', 'angry', 'sparkle'], (136, 171), (204, 131)), 'behind':(['blank', 'frown', 'frustrated', 'sad', 'smile', 'smilelow'], (68, 173), (103, 131)), 'cross':(['angry', 'rage', 'rageclosed', 'shock', 'stunned', 'wut'], (84, 193), (125, 163)), 'out':(['serious'], (0, 0), (0, 0))}
        make_sprites('shizu', shizu_list, ['cas', 'nak'])
        shizuyu_list = ['basic_angry', 'basic_aside', 'basic_blush', 'basic_happy', 'cross_angry', 'cross_aside', 'cross_blush', 'cross_happy']
        make_sprites('shizuyu', shizuyu_list)
        shizuyu_list_new = {'basic':(['angry', 'aside', 'blush', 'happy'], (84, 167), (150, 110)), 'cross':(['angry', 'aside', 'blush', 'happy'], (84, 167), (150, 110))}
        misha_list = ['perky_sad', 'perky_confused', 'perky_smile', 'sign_sad', 'sign_confused', 'sign_smile', 'hips_frown', 'hips_laugh', 'hips_grin', 'hips_smile', 'cross_frown', 'cross_laugh', 'cross_grin', 'cross_smile']
        make_sprites('misha', misha_list, ['cas', 'yuk'])
        make_sprites('mishashort', misha_list, ['cas'])
        misha_list_new = {'perky':(['sad', 'confused', 'smile'], (103, 163), (150, 110)), 'sign':(['sad', 'confused', 'smile'], (103, 164), (150, 110)), 'hips':(['frown', 'laugh', 'grin', 'smile'], (102, 168), (150, 110)), 'cross':(['frown', 'laugh', 'grin', 'smile'], (101, 164), (150, 110))}
        yuuko_list = ['closedhappy', 'cry', 'happy', 'neurotic', 'neutral', 'panic', 'smile', 'worried', 'noglasses']
    ...
    python:
        def slow_out(trans, st, at):
            ...
            trans.zoom = (0.80000000000000004) + ((((-(1.0)) * (acdc_warp(n))) + (1.0)) * (0.20000000000000001))
            return 0
    ...
    python:
        def roofcomposite(comppath):
            return im.Composite(None, (0, 0), 'event/rin_roof/rin_roof_boredom.jpg', (300, 200), comppath)



    image ev hisao_mirror = 'event/hisao_mirror.jpg'
    image ev hisao_mirror_800 = im.FactorScale('event/hisao_mirror.jpg', 0.80000000000000004)
    ...
    image ev rin_nap_total_awind_tears = LiveComposite((800, 600), (0, 0), 'ev rin_nap_total_awind', (0, 0), 'ev rin_nap_total_tears')


    image ev rin_nap_close_awind_tears = LiveComposite((800, 600), (0, 0), 'ev rin_nap_close_awind', (0, 0), 'ev rin_nap_close_tears')
    ...
    image evfg lilly_trainride_smiles = im.Composite(None, (0, 0), 'event/lilly_train/lilly_trainride.png', (338, 301), 'event/lilly_train/lilly_trainride_smile.png', (573, 331), 'event/lilly_train/lilly_trainride_hanasmile.png')
    ...
    python:
        def traincomposite(comppath):
            return im.Composite(None, (0, 0), 'event/lilly_train/lilly_trainride_ni_norm.png', (321, 200), comppath)
    ...
    image evfg hanako_breakdown_up = im.Composite(None, (0, 0), 'event/hanako_breakdown/hanako_breakdown_down.png', (588, 71), 'event/hanako_breakdown/hanako_breakdown_up.jpg')


    image evfg hanako_breakdown_closed = im.Composite(None, (0, 0), 'event/hanako_breakdown/hanako_breakdown_down.png', (588, 71), 'event/hanako_breakdown/hanako_breakdown_closed.jpg')



    image evul hanako_breakdown_down = im.Composite(None, (0, 0), 'event/hanako_breakdown/hanako_breakdown_bg.jpg', (0, 0), 'event/hanako_breakdown/hanako_breakdown_down.png')


    image evul hanako_breakdown_up = im.Composite(None, (0, 0), 'event/hanako_breakdown/hanako_breakdown_bg.jpg', (0, 0), 'event/hanako_breakdown/hanako_breakdown_down.png', (588, 71), 'event/hanako_breakdown/hanako_breakdown_up.jpg')



    image evul hanako_breakdown_closed = im.Composite(None, (0, 0), 'event/hanako_breakdown/hanako_breakdown_bg.jpg', (0, 0), 'event/hanako_breakdown/hanako_breakdown_down.png', (588, 71), 'event/hanako_breakdown/hanako_breakdown_closed.jpg')
    ...
    image evul hanako_emptyclassroom = im.FactorScale(im.Composite(None, (0, 0), 'event/hanako_emptyclassroom_bg.jpg', (0, 0), 'event/hanako_emptyclassroom_fg.png'), 0.80000000000000004)
    ...
    python:
        def zoomin_generic_f(trans, st, at):
            ...
            trans.yalign = 0.5
            n = scaled_runtime(20.0, at)
            trans.zoom = (0.94999999999999996) - ((acdc_warp(n)) * (0.14999999999999999))
            return 0
    ...
    image evmg kenji_glasses_frown = im.Composite(None, (0, 0), 'event/kenji_glasses/kenji_glasses_mg.png', (400, 190), 'event/kenji_glasses/kenji_glasses_frown.png')


    image evmg kenji_glasses_closed = im.Composite(None, (0, 0), 'event/kenji_glasses/kenji_glasses_mg.png', (400, 190), 'event/kenji_glasses/kenji_glasses_closed.png')


    image evfg kenji_glasses = 'event/kenji_glasses/kenji_glasses_fg.png'


    image evul kenji_glasses_normal = im.FactorScale(im.Composite(None, (0, 0), 'event/kenji_glasses/kenji_glasses_bg.jpg', (0, 0), 'event/kenji_glasses/kenji_glasses_mg.png', (0, 0), 'event/kenji_glasses/kenji_glasses_fg.png'), 0.80000000000000004)



    image evul kenji_glasses_frown = im.FactorScale(im.Composite(None, (0, 0), 'event/kenji_glasses/kenji_glasses_bg.jpg', (0, 0), 'event/kenji_glasses/kenji_glasses_mg.png', (400, 190), 'event/kenji_glasses/kenji_glasses_frown.png', (0, 0), 'event/kenji_glasses/kenji_glasses_fg.png'), 0.80000000000000004)




    image evul kenji_glasses_closed = im.FactorScale(im.Composite(None, (0, 0), 'event/kenji_glasses/kenji_glasses_bg.jpg', (0, 0), 'event/kenji_glasses/kenji_glasses_mg.png', (400, 190), 'event/kenji_glasses/kenji_glasses_closed.png', (0, 0), 'event/kenji_glasses/kenji_glasses_fg.png'), 0.80000000000000004)
    ...
    python:
        def shizu_roof_in_f(trans, st, at):
            ...
            trans.yalign = 1.0
            n = scaled_runtime(60.0, at)
            trans.zoom = (0.80000000000000004) + ((acdc_warp(n)) * (0.20000000000000001))
            return 0
    ...
    image ev shizu_roof_towardsangry = im.Composite(None, (0, 0), 'event/shizu_roof/shizu_roof.jpg', (299, 296), 'event/shizu_roof/shizu_roof_towardsangry.jpg')


    image ev shizu_roof_towardsnormal = im.Composite(None, (0, 0), 'event/shizu_roof/shizu_roof.jpg', (299, 296), 'event/shizu_roof/shizu_roof_towardsnormal.jpg')


    image ev shizu_roof_smile = im.Composite(None, (0, 0), 'event/shizu_roof/shizu_roof.jpg', (299, 296), 'event/shizu_roof/shizu_roof_smile.jpg')



    image ev shizu_roof2 = im.Composite(None, (0, 0), 'event/shizu_roof/shizu_roof.jpg', (601, 316), 'event/shizu_roof/shizu_roof_hisao2.jpg')


    image ev shizu_roof2_towardsangry = im.Composite(None, (0, 0), 'event/shizu_roof/shizu_roof.jpg', (601, 316), 'event/shizu_roof/shizu_roof_hisao2.jpg', (299, 296), 'event/shizu_roof/shizu_roof_towardsangry.jpg')



    image ev shizu_roof2_towardsnormal = im.Composite(None, (0, 0), 'event/shizu_roof/shizu_roof.jpg', (601, 316), 'event/shizu_roof/shizu_roof_hisao2.jpg', (299, 296), 'event/shizu_roof/shizu_roof_towardsnormal.jpg')



    image ev shizu_roof2_smile = im.Composite(None, (0, 0), 'event/shizu_roof/shizu_roof.jpg', (601, 316), 'event/shizu_roof/shizu_roof_hisao2.jpg', (299, 296), 'event/shizu_roof/shizu_roof_smile.jpg')
    ...
    image evh_hi shizune_hcg_tied_hisao2 = im.Composite((1600, 1200), (1080, 290), 'event/shizune_hcg_tied/shizune_hcg_tied_hisao2.png')

    image evh_hi shizune_hcg_tied_hisao2_small = im.Composite((800, 600), (540, 145), 'event/shizune_hcg_tied/shizune_hcg_tied_hisao2_small.png')



    image evhul shizune_hcg_tied_hisao2_small = im.Composite((800, 600), (0, 0), 'event/shizune_hcg_tied/shizune_hcg_tied_kinky3_small.jpg', (540, 145), 'event/shizune_hcg_tied/shizune_hcg_tied_hisao2_small.png')
    ...
    $ ex_g_images = (('thumb/other_iwanako.jpg', 'evul other_iwanako'), ('thumb/hisao_class.jpg', 'ev hisao_class_start', 'ev hisao_class_move', 'ev hisao_class_end'), ('thumb/kenji_rooftop.jpg', 'ev kenji_rooftop'), ('thumb/hisao_teacup.jpg', 'evul hisao_teacup'), ('thumb/hisao_letter.jpg', 'ev hisao_letter_closed', 'ev hisao_letter_open'), ('thumb/akira_park.jpg', 'evul akira_park'), ('thumb/emi_knockeddown.jpg', 'ev emi_knockeddown'), ('thumb/emi_run_face.jpg', 'ev emi_run_face'), ('thumb/emitrack_blocks.jpg', 'ev emitrack_blocks', 'ev emitrack_blocks_close', 'ev emitrack_blocks_close_grin'), ('thumb/emitrack_running.jpg', 'ev emitrack_running'), ('thumb/emitrack_finishtop.jpg', 'ev emitrack_finishtop'), ('thumb/emitrack_finish.jpg', 'ev emitrack_finish'), ('thumb/picnic.jpg', 'ev picnic_normal', 'ev picnic_rain'), ('thumb/emi_sleep.jpg', 'ev emi_sleep_unsure', 'ev emi_sleep_normal', 'ev emi_sleep_weep', 'ev emi_sleep_cry'), ('thumb/emi_sleepy.jpg', 'ev emi_sleepy', 'ev emi_sleepy_face', 'ev emi_sleepy_legs'), ('thumb/emi_firstkiss.jpg', 'ev emi_firstkiss'), ('thumb/emi_bed.jpg', 'ev emi_bed_normal', 'ev emi_bed_smile', 'ev emi_bed_happy', 'ev emi_bed_unsure', 'ev emi_bed_frown', 'ev emi_parkback', 'ev emi_parkback_frown'), ('thumb/emi_forehead.jpg', 'ev emi_forehead'), ('thumb/emi_grinding.jpg', 'evh emi_grinding_victory', 'evh emi_grinding_wink', 'evh emi_grinding_grin', 'evh emi_grinding_half_undress', 'evh emi_grinding_half_grin', 'evh emi_grinding_off_yawn', 'evh emi_grinding_off_closesurprise', 'evh emi_grinding_off_closearoused', 'evh emi_grinding_off_aroused', 'evh emi_grinding_off_arousedclosed', 'evh emi_grinding_off_come', 'evh emi_grinding_off_end'), ('thumb/emi_shed.jpg', 'evh emi_shed_base1', 'evh emi_shed_base3', 'evh emi_shed_base3', 'evh emi_shed_base4'), ('thumb/emi_grave.jpg', 'ev emi_grave'), ('thumb/emi_cry_down.jpg', 'evul emi_cry_down'), ('thumb/emi_miss.jpg', 'evh emi_miss_closed', 'evh emi_miss_open'), ('thumb/emi_ending.jpg', 'ev emi_ending_smile', 'ev emi_ending_serious', 'ev emi_ending_glad'), ('thumb/hana_library.jpg', 'ev hana_library', 'ev hana_library_read', 'ev hana_library_gasp'), ('thumb/hanako_shanghaiwindow.jpg', 'ev hanako_shanghaiwindow'), ('ev hanako_presents1', 'ev hanako_presents2'), ('thumb/hanako_crayon.jpg', 'ev hanako_crayon1', 'ev hanako_crayon2'), ('thumb/hanako_breakdown.jpg', 'evul hanako_breakdown_down', 'evul hanako_breakdown_up', 'evul hanako_breakdown_closed'), ('thumb/hanako_cry.jpg', 'ev hanako_cry_closed', 'ev hanako_cry_open', 'ev hanako_cry_away'), ('thumb/hanako_billiards.jpg', 'ev hanako_billiards_distant', 'ev hanako_billiards_serious', 'ev hanako_billiards_timid', 'ev hanako_billiards_smile', 'ev hanako_billiards_smile_close'), ('thumb/hanako_emptyclassroom.jpg', 'evul hanako_emptyclassroom'), ('thumb/hanako_rage.jpg', 'ev hanako_rage', 'ev hanako_rage_sad'), ('thumb/hisao_scar.jpg', 'ev hisao_scar'), ('thumb/hanako_scars.jpg', 'ev hanako_scars'), ('thumb/hanako_bed.jpg', 'evh hanako_bed_boobs_blush', 'evh hanako_bed_boobs_glance', 'evh hanako_bed_crotch_blush', 'evh hanako_bed_crotch_glance'), ('thumb/hanako_missionary.jpg', 'evh hanako_missionary_underwear', 'evh hanako_missionary_open', 'evh hanako_missionary_closed', 'evh hanako_missionary_clench'), ('thumb/hanako_after.jpg', 'ev hanako_after_worry', 'ev hanako_after_smile'), ('thumb/hanako_park.jpg', 'ev hanako_park_alone', 'ev hanako_park_away', 'ev hanako_park_look', 'ev hanako_park_closed'), ('thumb/hanako_goodend.jpg', 'unlock_ev hanako_goodend_close', 'unlock_ev hanako_goodend', 'unlock_ev hanako_goodend_muffin'), ('thumb/lilly_tearoom.jpg', 'ev lilly_tearoom', 'ev lilly_tearoom_open'), ('thumb/lilly_touch.jpg', 'ev lilly_touch_uni', 'ev lilly_touch_cheong', 'ev lilly_touch_cas'), ('thumb/lilly_crane.jpg', 'ev lilly_crane'), ('thumb/lilly_bedroom.jpg', 'ev lilly_bedroom'), ('thumb/lilly_hanako_hug.jpg', 'unlock_ev lilly_hanako_hug_end'), ('thumb/lilly_sleeping.jpg', 'ev lilly_sleeping', 'ev lilly_sleeping_smile'), ('thumb/lilly_trainride.jpg', 'ev lilly_trainride', 'ev lilly_trainride_smiles', 'ev lilly_trainride_ni'), ('thumb/lilly_wheat.jpg', 'unlock_ev lilly_wheat_close', 'ev lilly_wheat_small'), ('thumb/lilly_handjob.jpg', 'evhunlock lilly_handjob_chest_frown_small', 'evhunlock lilly_handjob_chest_normal_small', 'evh lilly_handjob_stroke_flustopen_small', 'evh lilly_handjob_stroke_normopen_small', 'evh lilly_handjob_stroke_normshut_small'), ('thumb/lilly_cowgirl.jpg', 'evh lilly_cowgirl_cry_small', 'evh lilly_cowgirl_frown_small', 'evh lilly_cowgirl_smile_small', 'evh lilly_cowgirl_strain_small', 'evh lilly_cowgirl_weaksmile_small'), ('thumb/lilly_bath.jpg', 'evh lilly_bath_emb_small', 'evh lilly_bath_grab_small', 'evh lilly_bath_moan_small', 'evh lilly_bath_open_small', 'evh lilly_bath_smile_small'), ('thumb/lilly_afterbath.jpg', 'evh lilly_afterbath_open_small', 'evh lilly_afterbath_shut_small'), ('thumb/lilly_kissing.jpg', 'ev lilly_kissing'), ('thumb/lilly_masturbate.jpg', 'evh lilly_masturbate', 'evh lilly_masturbate_come', 'evh lilly_masturbate_come_face'), ('thumb/lilly_restaurant.jpg', 'evul lilly_restaurant_listen', 'evul lilly_restaurant_sheepish', 'ev lilly_restaurant_eat', 'ev lilly_restaurant_chew', 'ev lilly_restaurant_wine'), ('thumb/lilly_sheets.jpg', 'ev lilly_sheets'), ('thumb/lilly_airport.jpg', 'ev lilly_airport', 'ev lilly_airport_end'), ('thumb/lilly_hospitalwindow.jpg', 'ev lilly_hospitalwindow'), ('thumb/lilly_hospital.jpg', 'unlock_ev lilly_hospitalclosed', 'unlock_ev lilly_hospital'), ('thumb/lilly_goodend.jpg', 'unlock_ev lilly_goodend'), ('thumb/rin_eating.jpg', 'ev rin_eating'), ('thumb/rin_artclass.jpg', 'ev rin_artclass1', 'ev rin_artclass2', 'ev rin_artclass3', 'ev rin_artclass4'), ('thumb/hisao_mirror.jpg', 'ev hisao_mirror_800'), ('thumb/rin_painting.jpg', 'ev rin_painting_base', 'ev rin_painting_foot', 'ev rin_painting_faceconcerned', 'ev rin_painting_concerned', 'ev rin_painting_reply'), ('thumb/rin_rain.jpg', 'ev rin_rain_away', 'ev rin_rain_towards'), ('thumb/rin_high.jpg', 'ev rin_high_frown', 'ev rin_high_grin', 'ev rin_high_grinwide', 'ev rin_high_oneeye', 'ev rin_high_open', 'ev rin_high_smile', 'ev rin_high_sleep'), ('thumb/rin_kiss.jpg', 'ev rin_kiss'), ('thumb/rin_nap.jpg', 'ev rin_nap_total', 'ev rin_nap_total_awind', 'ev rin_nap_close_awind', 'ev rin_nap_close_awind_tears'), ('thumb/rin_wisp.jpg', 'ev rin_wisp1', 'ev rin_wisp2', 'ev rin_wisp3', 'ev rin_wisp4', 'ev rin_wisp5'), ('thumb/rin_galleryskylight.jpg', 'ovl rin_galleryskylight'), ('thumb/rin_orange.jpg', 'ev rin_orange', 'ev rin_orange_large'), ('thumb/rin_masturbate.jpg', 'ev rin_masturbate_away', 'ev rin_masturbate_surprise', 'ev rin_masturbate_frown', 'ev rin_masturbate_doubt', 'ev rin_masturbate_hug'), ('thumb/rin_relief.jpg', 'evh rin_relief_down', 'evh rin_relief_up'), ('thumb/rin_gallery.jpg', 'ev rin_gallery'), ('thumb/rin_trueend.jpg', 'ev rin_trueend_normal', 'ev rin_trueend_smile', 'ev rin_trueend_weaksmile', 'ev rin_trueend_sad', 'ev rin_trueend_closed', 'ev rin_trueend_hug', 'ev rin_trueend_hugclosed', 'ev rin_trueend_gone'), ('thumb/rin_wet.jpg', 'ev rin_wet_pan_down', 'ev rin_wet_arms', 'ev rin_wet_face_up', 'ev rin_wet_face_down', 'ev rin_wet_towel_up', 'ev rin_wet_towel_down', 'ev rin_wet_towel_touch'), ('thumb/rin_h2.jpg', 'unlock_evh rin_h2_pan_surprise', 'unlock_evh rin_h2_pan_away', 'unlock_evh rin_h2_pan_closed', 'evh rin_h2_pan_closed', 'evh rin_h2_nopan_closed', 'evh rin_h2_hisao_closed'), ('thumb/rin_pair.jpg', 'ev rin_pair_base_clothes', 'ev rin_pair_base'), ('thumb/rin_h.jpg', 'evh rin_h_closed', 'evh rin_h_left', 'evh rin_h_normal', 'evh rin_h_right', 'evh rin_h_strain', 'evh rin_h_closed_close', 'evh rin_h_left_close', 'evh rin_h_normal_close', 'evh rin_h_right_close', 'evh rin_h_strain_close'), ('thumb/rin_goodend.jpg', 'ev rin_goodend_1', 'ev rin_goodend_1b', 'ev rin_goodend_2'), ('thumb/shizu_shanghai.jpg', 'ev shizu_shanghai', 'ev shizu_shanghai_borednormal', 'ev shizu_shanghai_smirknormal', 'ev shizu_shanghai_smirklaugh'), ('thumb/showdown.jpg', 'ev showdown'), ('thumb/shizu_chess.jpg', 'ev shizu_chess_base', 'ev shizu_chess_base3', 'ev shizu_chess_base2'), ('thumb/kenji_glasses.jpg', 'evul kenji_glasses_closed', 'evul kenji_glasses_frown', 'evul kenji_glasses_normal'), ('thumb/shizu_tanabata.jpg', 'ev shizutanabata'), ('thumb/shizu_confess.jpg', 'ev shizuconfess_normal', 'ev shizuconfess_closed', 'ev shizuconfess_smile'), ('thumb/shizu_hands.jpg', 'ev shizu_hands'), ('thumb/shizu_couch.jpg', 'ev shizu_couch'), ('thumb/shizune_car.jpg', 'ev shizune_car'), ('thumb/shizu_fishing.jpg', 'ev shizu_fishing_ah', 'ev shizu_fishing_sl'), ('thumb/shizune_tied.jpg', 'evh shizune_hcg_tied_blush_small', 'evh shizune_hcg_tied_smile_small', 'evh shizune_hcg_tied_stare_small', 'evh shizune_hcg_tied_close_small', 'evh shizune_hcg_tied_kinky1_small', 'evh shizune_hcg_tied_kinky2_small', 'evh shizune_hcg_tied_kinky3_small', 'evhul shizune_hcg_tied_hisao2_small'), ('thumb/misha_sad.jpg', 'ev misha_sad'), ('thumb/misha_naked.jpg', 'evh misha_naked'), ('thumb/misha_sex.jpg', 'evh misha_sex_aside', 'evh misha_sex_closed'), ('thumb/misha_roof.jpg', 'ev misha_roof_closed', 'ev misha_roof_angry', 'ev misha_roof_normal', 'ev misha_roof_sad'), ('thumb/shizu_roof.jpg', 'ev shizu_roof', 'ev shizu_roof_smile', 'ev shizu_roof_towardsnormal', 'ev shizu_roof_towardsangry', 'ev shizu_roof2_towardsangry'), ('thumb/shizu_flashback.jpg', 'ev shizu_flashback'), ('thumb/shizu_undressing.jpg', 'evh shizu_undressing_clothed_stare', 'evh shizu_undressing_clothed_kiss', 'evh shizu_undressing_clothed_blush', 'evh shizu_undressing_unclothed_blush', 'evh shizu_undressing_unclothed_closed', 'evh shizu_undressing_unclothed_kiss', 'evh shizu_undressing_unclothed_talk'), ('thumb/shizu_pushdown.jpg', 'evh shizu_pushdown'), ('thumb/shizu_straddle.jpg', 'evh shizu_straddle_open', 'evh shizu_straddle_tease', 'evh shizu_straddle_closed', 'evh shizu_straddle_smile', 'evh shizu_straddle_come'), ('thumb/shizu_table.jpg', 'evh shizu_table_smile', 'evh shizu_table_normal', 'evh shizu_table_comeopen', 'evh shizu_table_comeclosed'), ('thumb/misha_nightclass.jpg', 'ev misha_nightclass'), ('thumb/shizu_badend.jpg', 'ev shizu_badend'), ('thumb/shizu_goodend.jpg', 'ev shizu_goodend', 'ev shizu_goodend_pan'), ('thumb/cutin.png', 'pills', 'stuffedcat', 'teaset', 'shangpai', 'wine', 'musicbox closed', 'musicbox open', 'hanaphone', 'phonestrap', 'hanaphonestrap', 'insert startpistol', 'invite', 'sc_comp', 'brailler', 'chessboard', 'kenjibox', 'jigorocard', 'letter_insert', 'letter_open_insert', 'stallphoto_insert'), ('thumb/completionbonus.jpg', 'completionbonus'))
    ...
    python:
        shizuepiccomp = im.Composite((874, 836), (0, 0), sp_night('sprites/shizu/close/shizu_out_serious_close.png'), (2.5, 600), sp_night('vfx/shizu_out_serious_legs.png'))
        shizuepiccomp_sil = im.Composite((874, 836), (0, 0), silhouette('sprites/shizu/close/shizu_out_serious_close.png'), (2.5, 600), silhouette('vfx/shizu_out_serious_legs.png'))
    ...
    image ev emi_bed_full = LiveComposite((800, 1280), (0, 0), 'event/emi_bed_normal.jpg', (0, 600), 'event/emi_bed_legs.jpg')
    ...
    $ fw_dis_fast = Dissolve(0.040000000000000001, alpha=True)
    $ fw_dis_medium = Dissolve(0.20000000000000001, alpha=True)
    ...
    image fireworks = LiveComposite((800, 600), (0, 0), fw_constructor('vfx/fw1.png'), (0, 0), fw_constructor('vfx/fw2.png'), (0, 0), fw_constructor('vfx/fw3.png'), (0, 0), fw_constructor('vfx/fw4.png'), (0, 0), fw_constructor('vfx/fw5.png'), (0, 0), fw_constructor('vfx/fw6.png'), (0, 0), fw_constructor('vfx/fw7.png'), (0, 0), fw_constructor('vfx/fw8.png'), (0, 0), fw_constructor('vfx/fw9.png'))
    ...
    image fireshine = LiveComposite((800, 600), (0, 0), fw_constructor_nosparkle(Solid('#FF000009')), (0, 0), fw_constructor_nosparkle(Solid('#00FF0009')), (0, 0), fw_constructor_nosparkle(Solid('#0000FF09')), (0, 0), fw_constructor_nosparkle(Solid('#CC00CC09')), (0, 0), fw_constructor_nosparkle(Solid('#CCCC0009')), (0, 0), fw_constructor_nosparkle(Solid('#0000CC09')))
    ...
    image hanako_fw = LiveComposite((800, 600), (0, 0), hanako_fw_constructor(1.0, 1.0, 1.0), (0, 0), hanako_fw_constructor(1.1000000000000001, 0.90000000000000002, 0.90000000000000002), (0, 0), hanako_fw_constructor(0.90000000000000002, 1.1000000000000001, 0.90000000000000002), (0, 0), hanako_fw_constructor(0.90000000000000002, 0.90000000000000002, 1.1000000000000001), (0, 0), hanako_fw_constructor(0.90000000000000002, 1.05, 1.05), (0, 0), hanako_fw_constructor(1.05, 0.90000000000000002, 1.05), (0, 0), hanako_fw_constructor(1.05, 1.05, 0.90000000000000002))
    ...
    $ rain_trans = Dissolve(0.10000000000000001, alpha=True)
    ...
    image rain normal = LiveComposite((800, 600), (0, 0), rainAnim(), (0, 0), rainAnim(my_offset=0.10000000000000001, zoom=1.2))





    image rain light = LiveComposite((800, 600), (0, 0), rainAnim(alpha=0.29999999999999999), (0, 0), rainAnim(my_offset=0.10000000000000001, zoom=1.2, alpha=0.29999999999999999))




    image rain medium = LiveComposite((800, 600), (0, 0), rainAnim(alpha=0.59999999999999998), (0, 0), rainAnim(my_offset=0.10000000000000001, zoom=1.2, alpha=0.59999999999999998))
    ...
    $ crowdtrans = Dissolve(0.29999999999999999, alpha=True)
...
init python:
    def night(img_in):
        return im.MatrixColor(img_in, (im.matrix.tint(0.59999999999999998, 0.59999999999999998, 0.69999999999999996)) * (im.matrix.saturation(0.59999999999999998)))
    def sp_night(img_in):
        return im.MatrixColor(img_in, (im.matrix.tint(0.90000000000000002, 0.92000000000000004, 1.0)) * (im.matrix.brightness(-(0.050000000000000003))))
    def sunset(img_in):
        return im.MatrixColor(img_in, ((im.matrix.tint(1.1000000000000001, 0.94999999999999996, 0.84999999999999998)) * (im.matrix.brightness(0.10000000000000001))) * (im.matrix.saturation(1.2)))
    def sp_sunset(img_in):
        return im.MatrixColor(img_in, ((im.matrix.tint(1.02, 0.94999999999999996, 0.90000000000000002)) * (im.matrix.brightness(0.050000000000000003))) * (im.matrix.saturation(1.1000000000000001)))
    def past(img_in):
    ...
    def past_night(img_in):
        return im.MatrixColor(img_in, (((im.matrix.tint(0.59999999999999998, 0.59999999999999998, 0.69999999999999996)) * (im.matrix.saturation(0.59999999999999998))) * (im.matrix.saturation(0.14999999999999999))) * (im.matrix.tint(1.0, 0.93999999999999995, 0.76000000000000001)))
    bg_filters = ((sunset, 'ss'), (night, 'ni'), (rain, 'rn'))
    sp_filters = ((sp_sunset, 'ss'), (sp_night, 'ni'), (sp_rain, 'rn'))
    letterbox = LiveComposite((800, 600), (0, 0), Solid('#000', ymaximum=75), (0, 525), Solid('#000', ymaximum=75))
    ...
    hands_in = ImageDissolve('vfx/handsdissolve.png', 0.20000000000000001, ramplen=256, reverse=True)
    hands_out = ImageDissolve('vfx/handsdissolve.png', 0.20000000000000001, ramplen=256)
    ...
    renpy.image('snow', LiveComposite((800, 600), (0, 0), snowbg, (0, 0), snowfg))
    ...
    silentflash = Fade(0.25, 0, 0.75, color='#FFFFFF')
    ...
    cameraflash = Fade(0.050000000000000003, 0.10000000000000001, 0.75, color='#FFFFFF')
    cameraflashlong = Fade(0.050000000000000003, 0.10000000000000001, 4.0, color='#FFFFFF')
    sakura = SnowBlossom(anim.Filmstrip('vfx/sakura.png', (10, 10), (2, 1), 0.25), xspeed=(150, 100), yspeed=(75, 150), count=80, fast=True)
    ...
    renpy.image('dandelions thin', LiveComposite((800, 600), (0, 0), dandeliontbg, (0, 0), dandeliontfg))
    ...
    renpy.image('dandelions dense', LiveComposite((800, 600), (0, 0), dandeliondbg, (0, 0), dandeliondfg))
    ...
    steam = anim.TransitionAnimation('vfx/steam1.png', 1.5, Dissolve(0.5, alpha=True), 'vfx/steam2.png', 1.5, Dissolve(0.5, alpha=True), 'vfx/steam3.png', 1.5, Dissolve(0.5, alpha=True))
    steam2 = anim.TransitionAnimation('vfx/steam3.png', 0.75, Dissolve(0.5, alpha=True), 'vfx/steam1.png', 1.5, Dissolve(0.5, alpha=True), 'vfx/steam2.png', 1.5, Dissolve(0.5, alpha=True), 'vfx/steam3.png', 0.75, None)
    ...
    runningspline = SplineMotion([((0.46999999999999997, 0.48499999999999999), ), ((0.50800000000000001, 0.52500000000000002), (0.48399999999999999, 0.46400000000000002), (0.48199999999999998, 0.54100000000000004)), ((0.51800000000000002, 0.48299999999999998), (0.53400000000000003, 0.51200000000000001), (0.53200000000000003, 0.48799999999999999)), ((0.47999999999999998, 0.52800000000000002), (0.50600000000000001, 0.46400000000000002), (0.5, 0.54400000000000004)), ((0.46999999999999997, 0.48499999999999999), (0.46600000000000003, 0.52000000000000002), (0.45200000000000001, 0.50700000000000001))], 1.1000000000000001, anchors=(0.5, 0.5), repeat=True)
    fastrunningspline = SplineMotion([((0.46999999999999997, 0.48499999999999999), ), ((0.50800000000000001, 0.52500000000000002), (0.48399999999999999, 0.46400000000000002), (0.48199999999999998, 0.54100000000000004)), ((0.51800000000000002, 0.48299999999999998), (0.53400000000000003, 0.51200000000000001), (0.53200000000000003, 0.48799999999999999)), ((0.47999999999999998, 0.52800000000000002), (0.50600000000000001, 0.46400000000000002), (0.5, 0.54400000000000004)), ((0.46999999999999997, 0.48499999999999999), (0.46600000000000003, 0.52000000000000002), (0.45200000000000001, 0.50700000000000001))], 0.80000000000000004, anchors=(0.5, 0.5), repeat=True)
    config.nvl_page_ctc = anim.Filmstrip('ui/ctc_strip.png', (16, 16), (8, 8), 0.029999999999999999, ypos=560, xpos=772)
    ...
    def define_characters():
        ...
        store.adv = ReadbackADVCharacter(name=None, ctc=config.nvl_page_ctc, ctc_position='fixed', show_function=quotefixer, what_prefix=displayStrings.quote_outer_open, what_suffix=displayStrings.quote_outer_close, **add_styles)
        ...
        store.n = ReadbackNVLCharacter(None, kind=nvl, ctc=anim.Blink(im.Rotozoom('ui/ctc.png', 270, 1.0), offset=1.0, ypos=560, xpos=772), ctc_position='fixed', **add_styles)
        store.nb = Character(None, kind=adv, ctc=None, what_color='#666666', what_line_spacing=8, what_prefix='', what_suffix='', show_function=say_wrapper, window_style='b_nvl_window')
        store.rinbabble = Character(None, kind=n, what_prefix=(((u"{color=#FF8D7C}{b}") + (displayStrings.name_rin)) + ('{/b}{/color}\n')) + (displayStrings.quote_outer_open), what_suffix=displayStrings.quote_outer_close)
    ...
    whip_right = ImageDissolve(im.Tile('vfx/tr-softwipe.png'), 0.29999999999999999, 256, ramptype='mcube')
    whip_left = ImageDissolve(im.Tile('vfx/tr-softwipe.png'), 0.29999999999999999, 256, ramptype='mcube', reverse=True)
    ...
    define.move_transitions('slice_in', 0.20000000000000001, _ease_in_time_warp)
    ...
    config.window_show_transition = Dissolve(0.20000000000000001)
    config.window_hide_transition = Dissolve(0.20000000000000001)
    ...
    def wdt_show(trans=dissolve):
        ...
        renpy.with_statement(trans)
        wdt_on()
    config.label_overrides = {'_noisy_return':'custom_noisy_return', '_return':'custom_return', '_confirm_quit':'quit_from_os', '_game_menu':'_custom_game_menu'}
    def ib_base(image, **options):
        return im.MatrixColor(image, im.matrix.opacity(0.40000000000000002), **options)
    def ib_disabled(image, **options):
        return im.MatrixColor(image, im.matrix.opacity(0.10000000000000001), **options)
    ...
    def main_menu_composer(is_animated):
        if (is_animated and store.animate_mm):
            ...
            is_animated = False
        widget_map = [('tc_act4_shizune', (677, 308), '16_tc4-shizune.png'), ('tc_act3_shizune', (681, 383), '15_tc3-shizune.png'), ('tc_act2_shizune', (620, 476), '14_tc2-shizune.png'), ('tc_act4_rin', (526, 190), '13_tc4-rin.png'), ('tc_act3_rin', (590, 232), '12_tc3-rin-rin.png'), ('tc_act3_rin', (637, 295), '11_tc3-rin-hisao.png'), ('tc_act2_rin', (629, 402), '10_tc2-rin.png'), ('tc_act4_lilly', (464, 201), '09_tc4-lilly.png'), ('tc_act3_lilly', (529, 279), '08_tc3-lilly.png'), ('tc_act2_lilly', (582, 375), '07_tc2-lilly.png'), ('tc_act4_hanako', (382, 279), '06_tc4-hanako.png'), ('tc_act4_emi', (375, 370), '05_tc4-emi.png'), ('tc_act3_emi', (429, 453), '04_tc3-emi.png'), ('tc_act2_emi', (463, 498), '03_tc2-emi.png'), ('tc_act3_hanako', (469, 312), '02_tc3-hanako.png'), ('tc_act2_hanako', (493, 380), '01_tc2-hanako.png'), ('tc_act1', (552, 473), '00_tc1-hisao.png')]
        basedelay = 0.070000000000000007
    ...
    style.note_window.background = Frame('ui/bg-note.png', 0, 16, tile=False)
    ...
    style.gm_nav_frame.yalign = 0.40000000000000002
    ...
    style.yesno_frame.ypadding = 0.050000000000000003
    ...
    style.yesno_frame.xpadding = 0.10000000000000001
    ...
    style.file_picker_frame.yalign = 0.41999999999999998
    ...
    if not (persistent.bad):
        persistent.bad = 0
    if (not (persistent.seen_videos) or not ('video/4ls.mp4') in (persistent.seen_videos)):
        persistent.seen_videos = ['video/4ls.mp4']
    def init_vars():
