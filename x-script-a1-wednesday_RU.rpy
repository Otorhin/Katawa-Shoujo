...
"Минут через десять после начала урока заходит Ханако и молча занимает своё место. Никто не смотрит на неё, даже учитель не обращает внимания на её опоздание."
...
"Похоже, её волнует не столько количество, сколько само наличие работы. Ко всему она приступает с одинаковым рвением."
...
mi "Мммм… Нет, не думаю, что это хорошая идея, %(name_hicchan)s."
...
"Мне стало сложно сосредотачиваться на книге, перерыв манит меня прочь из скучного класса. Я повинуюсь, направляясь в столовую."
...
"Ханако слегка кивает в ответ, а я задаюсь вопросом, не является ли грубостью различать людей по типам их инвалидности, или же здесь это считается нормальным?"
...
"Кажется, она опять начинает нервничать из-за меня."
...
"Ханако опять бросает через плечо взгляд на %(name_shizune)s, словно пытаясь удостовериться, что та их не слышит… Хотя это невозможно."
...
hi "Привет, Лилли. Как ты? Извини, что тебе вчера пришлось убежать из-за меня…"
...
li "Если ты озадачен чем-то, пожалуйста, не стесняйся спрашивать."
...
"Сразу за углом коридора удар в грудь с силой несущегося на всей скорости поезда чуть не сбивает меня с ног."
...
"Они принадлежат виновнице столкновения – низенькой девочке, которая валяется на полу передо мной."
...
"Хоть я и сказал, что всё в порядке, я понимаю, что подобный удар – одна из сильнейших опасностей; в моей груди растёт острая боль."
...
"Она только что чуть не вышибла из меня дух. Но, похоже, всё цело."
...
emi_ "Ээ, извините, мне просто надо было забрать кое-что, и я немного торопилась."
...
"Мы знакомы всего три дня. Неужели мы так быстро сумели подружиться?"
...
"Я никогда раньше не был в чайном доме, только видел их по телевизору в исторических фильмах. Возможно, сейчас это всего лишь обычные кафе, в которых от тех «чайных домов» – одно название."
...
show hanako defarms_worry behind em at offscreenright
with None
...
"Конечно, Лилли не в курсе событий, но её голос звучит крайне взволнованно. Хотя в этой ситуации такое волнение излишне."
...
emi_ "Ээ, извини, я нечаянно. Мне просто надо было срочно забрать кое-что, и я очень торопилась."
...
"Маленькая девочка смущённо кашляет и шаркает «ногами», сделанными из какого-то метала или пластика, глядя на них, прежде чем сказать что-либо в ответ."
...
mi "Конечно, %(name_hicchan)s~! %(name_uchan)s у нас в библиотеке работает, в конце концов~! Я редко хожу туда сама, но %(name_sicchan)s её знает! И~!, мы часто приходим сюда, поэтому получается, что мы постоянно видимся с ней!"
...
"Юко снова начала быстро кланяться. Бросив попытки помочь ей, я сажусь за столик %(name_shizune)s и Миши."
...
"%(name_shizune)s недовольно смотрит на меня, кажется пытаясь определиться, как уместнее выглядеть в этой ситуации: удивлённо или негодующе."
...
mi "%(name_hicchan)s, вот у тебя в бумажнике сколько денег? Ведь что-то точно есть, да? Нам надо разделить стоимость на троих, чтобы было честно~! Да, и на другое я не согласна~!"
...
mi "Уу, но ведь правда же, %(name_hicchan)s~! Ты бы нас очень выручил, в этом году у нас совсем мало людей."
...
mi "%(name_hicchan)s, две прелестные представительницы Школьного совета оказывают тебе радушный приём и даже угощают ланчем. Тебе бы следовало выразить свою признательность, вступив в Совет, чтобы помочь им."
...
mi "Хмм~… Прости, %(name_hicchan)s, не скажу."
...
mi "А-ха-ха-ха-ха~! О чём ты задумался, %(name_hicchan)s~? Ты ведь не думаешь, что мы играли с тобой всё это время?"
...
mi "%(name_hicchan)s, ты действительно думал?.."
...
"Миша спрашивает с такой наивной серьёзностью, будто правда полагает, что я её не узнал."
...
"Я пытаюсь их обойти, но %(name_shizune)s проворно останавливает меня. Похоже, годы игры в футбол прошли даром. Наше поведение привлекает слишком много лишних взглядов. Надо было убежать, когда такая возможность была."
...
"Учитывая, как Ханако реагировала на мои попытки пообщаться последние пару дней, я понимаю, что это к лучшему. К тому же так Лилли удаётся урвать несколько минут тишины вдали от своего класса."
...
"Полагаю, это одно из местных негласных правил: «не спрашивай». Даже если проблема очевидна – как у Ханако, – всё равно есть рамки, и история её возникновения находится за ними."
...
li "Хмм… ну, я здесь с начала старшей школы, но переехала в общежитие только год назад."
...
"Соседство с кем-то, возможно, является уже достаточной причиной, чтобы подружиться, хотя думаю, что слепота Лилли тоже сыграла в этом роль."
...
"Проходит немного времени, и звон колокола возвещает окончание перерыва. Девушки убирают свои ланчи так же быстро, как и доставали их, и я следую их примеру."
...
"Ханако смотрит на меня, и несколько мгновений ясно видно, что она подумывает пропустить урок, возможно, просто чтобы не входить в класс вместе со мной."
...
"Интересно, это какое-то неофициальное соглашение с персоналом или «прерогатива» для особых учеников этой школы?"

"Стараясь не шуметь, я достаю из сумки нужный учебник и начинаю нагонять остальных."
...
hi "Эмм… ничего. Я думал, чем бы заняться после школы."
...
hi "Просто не могу взять в толк, как мне относиться к их инвалидности? Совсем не обращать на это внимание было бы невежливо, а игнорировать – как-то странно."
...
mi "Фанера! Вся проблема в фанере! В прошлый раз, когда нам понадобилось больше, её запасы там уже подходили к концу, и мы просто взяли всю оставшуюся, и нам вроде бы хватило."
...
mi "Ааа! Но я спешу! Мы слишком заняты!"
...
hi "Ээ… Думаю, я мог бы вам помочь."
...
"В ближайших к нашему кабинетах располагаются классы 3-1 и 3-2 по правой стороне и 3-4 по левой, и все двери выглядят совершенно одинаково."

"Дальше по коридору с одинаковыми дверьми находятся кабинеты, для проведения уроков, как я считал, не используемые."

"Наверное, кабинет кружка рисования где-то среди них."
...
"Облачка пыли танцуют в недвижимом воздухе, делая лучи света почти осязаемыми."
...
"На парте сидит коротко стриженая девушка, к моему удивлению, в мужской школьной форме. Между пальцев ног у неё зажата вилка, на которую нанизан кусочек еды."
...
"Она смотрит на меня, держа вилку у открытого рта."
...
hi "Мм… привет. Меня попросили забрать отсюда кое-что. Для фестивальных киосков, в смысле. Я не думал, что тут кто-то есть."
...
rin_ "А меня – Рин. %(name_tezuka)s Рин. Рин %(name_tezuka)s."
...
hi "Так ты что, просто… типа, ходишь и спрашиваешь у них, что с ними не так?"
...
"Говорить больше не о чем, и Рин возобновляет обед, а я продолжаю думать над тем, что она сказала."

"Я впервые рассказал кому-то о своём недуге. Все остальные либо уже знали, либо слышали об этом от кого-то ещё."

"Или же им до настоящего момента необязательно было знать об этом, как и всем прочим ученикам этой школы."

"Мне следует об этом упоминать при знакомстве? От меня этого ожидают?"
...
"Или, может быть, у этой Тэдзуки просто странный интерес к подобным вещам?"
...
"Когда я иду в конец кабинета за вещами из Мишиного списка, мне представляется шанс понаблюдать за Рин краем глаза."
...
"Она ничем особо не привлекательна, разве что тёмно-зелёными глазами, которыми она беспрестанно моргает из-под короткой чёлки, даже когда ест."
...
"Мы снова погружаемся в молчание, пока Рин доедает остатки своего обеда."

"Я смотрю на свою поклажу, сверяясь с Мишиным списком. Похоже, я достал всё, за исключением фанеры."

hi "Эмм… ну, думаю, я всё нашёл."
...
hi "Даже если бы и нравилось, думаю, мне пора."

hi "Ещё… Ещё увидимся, %(name_tezuka)s."
...
mi "Нет, постой, важнее, кто там? Сегодня в кружке нет занятий."

"Она пытается с любопытством выглянуть из-за меня, несмотря на то, что закрытая дверь не даст ей ничего увидеть."
...
"С её трудолюбием и жизненными принципами ей не под силу вынести дерзость, с которой некто осмелился портить школьное имущество, используя его в качестве поверхности для сна."
...
mi "Мисс %(name_tezuka)s, что это вы вытворяете? У вас нет абсолютно никакого права использовать школьное имущество для таких… ээ, постыдных? занятий!"
...
mi "Мисс %(name_tezuka)s, пожалуйста, попытайтесь подойти к этому ответственнее. Будет катастрофой, если стена будет выглядеть так, будто кто-то швырнул в неё свой обед."
...
"Она только качает головой, забирает у меня материалы и уходит в сопровождении Миши."
...
rin "Не мог бы мне помочь, раз ты ничем не занят?"
...
"Она легонько пинает огромную банку краски, лежащую на полу рядом со столом, на котором она сидела и спала."
...
nk "О, Накай, какое совпадение! И %(name_tezuka)s, конечно."
...
nk "Я буду регулярно брать у тебя анализы, но я хочу, чтобы ты сообщал мне об отклонениях в своём состоянии, – если ты понимаешь, о чём я."
...
nk "Мои источники сообщили, что ты не был ни на школьном стадионе, ни в бассейне, так что я хочу поинтересоваться: выполняешь ли ты упражнения, которые я рекомендовал?"
...
"Я несколько раз поднимаю и опускаю банку, изображая жалкую пародию на культуриста, хоть она и врезается болезненно мне в руку."
...
nk "%(name_tezuka)s, позволь, мы с ним наедине поговорим?"
...
"Он уходит без ответа, помахав рукой, а я подхожу к Рин, которая ждёт, праздно опершись о стену коридора и разглядывая тусклые светильники на потолке."
...
"Фельдшер, похоже, тоже незнаком с понятием врачебной тайны, раз говорит о таких вещах на людях."
...
"Вся стена, построенная из таких же кирпичей, что и само здание, покрыта своего рода картиной."
...
"Я сильно краснею. Даже не знаю, что тут правильнее будет сказать, если вообще можно сказать что-то. Однако кажется, что я куда более чувствительный, чем Рин."
...
rin "Ты догадлив. Как бы то ни было, думаю, не трудно. Но, может быть, я просто уже привыкла."
...
hi "Ээ, ну, картины обычно плоские."
...
hi "Ладно, я понял. Но я ничем не могу помочь, потому что не слишком хорошо разбираюсь в искусстве. Я не знаю много художников или специальных терминов."
