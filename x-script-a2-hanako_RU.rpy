...
n "Однако, стоит лишь выйти за пределы школьных ворот, как мы вновь ощущаем себя «изгоями»."

n "Особенно находясь в школьной форме. Будто вешаем себе на шею объявление, побуждающее людей заинтересоваться, что же с нами не так."
...
"Звук упавшего стула эхом разносится по пустой комнате, и тут же из-за стойки появляется голова."
...
"Последовав её совету, шагая за Ханако, я подвожу Лилли к ближайшей кабинке."
...
"С большой осторожностью Юко ставит поднос на стол, едва удержав его от падения."
...
"Ах, точно. Когда я впервые встретился с Ханако, Лилли и Юко обсуждали какие-то книги."
...
yu "Я буду в библиотеке завтра днём, если ты захочешь попробовать ещё раз…"
...
"Мы все, за исключением Лилли, несёмся к небольшому окну чайной, чтобы посмотреть фейерверк."

"Вспышки цветных огней играют на лицах Ханако и улыбающейся Юко, и на секунду я отвожу взгляд от окна."
...
hi "Во всяком случае, наше чаепитие слишком затянулось, поэтому давай вернёмся к столу."
...
yu "Ага, было здорово! Не думала, что они смогут организовать такое представление."
...
hi "Спасибо за сегодня. Думаю, я многое для себя открыл."
...
li "Всегда пожалуйста. Боюсь, я действительно должна идти. Сегодня был длинный день."
...
"Звук будильника бьёт по ушам, но тут же замолкает от стремительного удара кулаком."
...
"Сам не успев заметить, как добрался, я уже открываю дверь в класс 3-3. Не без удовольствия отмечаю, что я не единственный, кто после фестивальной недели выглядит будто с похмелья."
...
mi "Я-хоооо~! Наконец-то всё закончилось!"
...
mi "На самом деле я думаю, что она просто немного обиделась, так как ты не провёл этот день вместе с ней."
...
mi "БВАХАХА! А ты не теряешь время, %(name_hicchan)s~? Что ж, не будем мешать твоим сегодняшним планам! Ахахаха!"
...
"Немного странно. Снаружи «Ямаку» выглядит абсолютно так же, как и любая другая старшая школа, но эта иллюзия исчезает, как только на глаза попадается кто-нибудь в инвалидной коляске или с отсутствующей конечностью."
...
"На моём столе лежит куча бумаг, требуя разобраться с ней. Прошлая неделя была такой суматошной, что я просто не успевал ничего сделать вовремя."

"Я старался не отставать от учёбы, когда был в больнице, но часть этого материала я никогда раньше не видел, даже в прежней школе."
...
"Ханако вздыхает с облегчением, и я собираю свои вещи."
...
hi "Я так и думал. Похоже, она присосалась. И нам понадобится немного горячей воды, чтобы её открыть."
...
"В дверях стоит Лилли. Улыбаясь, она держит пакет, наполненный различными булочками и другой выпечкой. Я тоже не могу сдержать улыбки."

show lilly basic_smileclosed
with charachange

li "Поскольку благодаря мне у вас изменились планы, я решила вам что-нибудь принести."
...
"Благодаря предусмотрительности Лилли на тарелке Ханако, так и не увидевшей риса, появляется различный хлеб. Я торопливо завариваю чай, чтобы завершить картину."
...
hi "Приготовлено хорошо. Я просто был немного удивлён набором продуктов."

show lilly basic_weaksmile
with charachange

li "Ханако никогда не упустит шанса поэкспериментировать, когда дело доходит до еды. Я думаю, что это хорошо… иногда… время от времени."
...
"Я замечаю, что исподволь слежу за палочками Лилли. Мягко касаясь, она аккуратно водит ими по тарелке для того, чтобы определить месторасположение еды, а потом ловко подхватывает очередной кусочек."
...
"У входа в класс я беру инициативу и открываю дверь перед Ханако, заранее склоняя свою голову в извинении."
...
"Прежде чем я успеваю встать, %(name_shizune)s и Миша кладут руки мне на плечи."
...
"Ханако, пытаясь покинуть комнату, робко подходит к нам, и я вдруг понимаю, что она может стать моим единственным шансом на спасение."
...
"И почему они не могли отсортировать их, пока собирали?"
...
mi "%(name_sicchan)s боится, что если ты не будешь под наблюдением, то сделаешь что-нибудь неправильно."
...
"Потом они раскалываются отдельно на хорошие и плохие отчёты и так далее, пока не создаётся впечатление, что мы только разбрасываем бумаги по всему столу."
...
"Но спорить всё равно нет смысла."
...
mi "Что за дела у тебя с Ханако?"
...
"Что кажется непростым даже для тренированного ума."

"А у Миши ум, честно говоря, не самый блестящий."
...
mi "Это кое-какие излишки, оставшиеся после праздника. Поскольку официально это касается фестиваля, мне удалось урвать немного для нас."
...
mi "Спасибо за сегодняшнюю помощь. Большую часть времени мы просто занимались заполнением отчётов за персонал."
...
mi "Твою работу можно считать выполненной. Tы можешь идти."
...
"Отпустив мои плечи, %(name_shizune)s и Миша долго, серьёзно беседуют."

show misha sign_smile_close
with charachange

mi "Ладно, как знаешь. Если честно, то мы просто хотели отдохнуть за столом, купив пирожные на остатки из выделенного на фестиваль бюджета."

show misha cross_laugh_close
with charachange

mi "Так что если ты не с нами – нам же лучше. Больше достанется. Вахахаха~!"
...
"Едва мы входим в дверь, как Ханако прилипает к прилавку, за которым Юко складывает книги."
...
"Я перевожу взгляд на Юко. У неё вид, будто она взорвётся, если срочно не расскажет кому-нибудь секрет Ханако."
...
yu "Прости, Ханако… само сорвалось…"
...
"С другой стороны, по крайней мере это значит, что она хочет сыграть со мной снова. Это же плюс, верно?"

hi "Хах, ну это же не значит, что я гроссмейстер или что-то вроде того. Я просто немного играл перед…"

"Мне приходит в голову, что я ни разу не говорил Ханако о своём состоянии. На секунду впав в замешательство, я раздумываю, как выкрутиться. Сегодня – не лучший день для такого разговора."
...
"Но по некоторым причинам я пока не могу об этом говорить, по крайней мере не сегодня. Сначала нужно всё продумать как следует."
...
"…изданная в 1982 году. Ну, не совсем актуальная, но по крайней мере вполне может оказаться интересной."
...
"Не сказав ни слова, мы просто открываем наши книги и приступаем к чтению."
...
"Большинство из них были сделаны из дерева. Не думаю, что рискнул бы прокатиться на таких."

"А если бы я и решился проехать на чём-то потенциально опасном, то предпочёл бы, чтобы оно было сделано из стали или некоторых сплавов космической эры, таких как титан и рутений."
...
"Похоже, что Ханако поглощена чтением. Перелистывая взад-вперёд страницы, она будто пытается закрепить только что прочитанное."
...
"Эти вопросы похожи на те, что задаёшь новичку, только перешедшему в твою школу. Правда, переведённые на местный язык."

"Но до настоящего времени никто не задал мне ни одного подобного вопроса. Ну, за исключением Рин. Но вряд ли её можно предъявить в качестве примера по надлежащему поведению в обществе."
...
"Юко считывает штрих-код книжки Ханако отработанным движением, но всё равно у неё это получается не сразу."
...
hi "А, неважно. Я просто подумал, что никогда не встречал библиотекаря, который может распланировать свой день. Независимо от того, насколько легко он обращается со своими книгами."
...
"Мы проходим через сад и наконец оказываемся перед зданиями общежитий."
...
"Недосып клонит голову вниз, и есть только одно средство от этого: хороший, сытный завтрак."
...
"Полагаю, есть небольшой слой людей, которые по той или иной причине встают ни свет ни заря."
...
"Трудно не позавидовать такой дисциплине, особенно когда сам не в состоянии себя организовать."
...
"Каждое её движение словно лишено жизненной энергии. Полагаю, они сродни блуждающему взгляду во время выполнения повседневных рутинных дел."
...
hi "Я не знал, считается это грубостью или нет, поэтому пытался вообще не думать об этом. Не относиться к окружающим как-то иначе."
...
hi "Э-э, на самом деле у меня осталось совсем немного денег, поэтому не уверен, что получится куда-либо выбраться…"

show lilly basic_smile
with charachange

li "О, я не подразумевала прогулку по городу. Мы хотели собраться здесь этим вечером."
...
"Хотя я и понимаю, что это приглашение не имеет никакого скрытого намёка, меня не покидают мысли о возможностях."
...
"Её руки зажаты между колен, плечи выдаются вперёд, голова опущена, будто она пытается в ней спрятаться."

"И ей было бы несложно это сделать: её халат выглядит размера на два больше, чем нужно."

"Складки фланелевой ткани халата делают её похожей на ребёнка, который играя примеряет гардероб своих родителей."

"Она поднимает взгляд, чтобы удостовериться, что это я. На её лице проскальзывает чуть заметная улыбка, а затем немедленно снова исчезает, как будто её там никогда и не было."
...
"Пока я усаживаюсь, бросаю мимолётный взгляд на Лилли."
...
"Слева от меня сидит Лилли в тёмно-синем, а с правой стороны – Ханако, одетая в розовое."
...
"Стоящий на столе алый чайный сервиз с цветочками выглядит практичным и очень милым."
...
"Она делает резкий вдох. Должно быть, она действительно очень нервничает, хотя этот звон – не то, из-за чего стоило бы беспокоиться."
...
"Я делаю то же самое. Этот чай на вкус лучше, чем тот, что мы обычно пьём в школе."
...
n "Я не пластический хирург, и не могу изменить её внешность, и не психолог, способный помочь ей стать более общительной."
...
n "Но всё же я не вижу ничего плохого в том, что мы с Ханако становимся хорошими друзьями. Теперь, когда она стала ко мне теплее относиться, мне нравится проводить с ней время."
...
n "Похоже, что Лилли действительно беспокоится о ней, но это не значит, что я в силах помочь ей."
...
"Ханако вслед за мной осторожно встаёт."
...
ke "Я хотел было прикупить жратвы в комнату, но обнаружил, что нужна мелочь."
...
"Пока он отсчитывает 400 иен, что мне должен, я замечаю по меньшей мере пару десятитысячных купюр."
...
li "О, Хисао, как дела? Боюсь, я не встречалась с Ханако с самого утра."
...
li "Так она по-прежнему рано уходит из класса…"
...
li "Всё немного сложнее, чем кажется. Готова поспорить, первое, чем большинство интересуется, так это её шрамы и то, как она их получила."
...
"Мы покидаем комнату и, повернувшись друг к другу спиной, расходимся в противоположных направлениях. Всё же я надеюсь, что она не вступит в очередную словесную перепалку с %(name_shizune)s."
...
"Опять же, я мало знаю каждую из них. А вдруг ранее они были лидерами некоего тайного общества, но их любовь друг к другу развела их в разные стороны…"
...
hi "Спасибо. Какие-нибудь новые книги появились?"
...
"Я прохожу знакомый путь к уголку, где Ханако любит сидеть с книгой, по пути рассматривая названия на корешках."
...
"Ну хоть не придётся перечитывать старый материал."
...
hi "Не страшно. Расскажи, как прочитаешь; я, может, тоже её возьму."
